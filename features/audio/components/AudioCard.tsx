 ...
 * Gère la lecture, la boucle, la vitesse et les actions (modifier, supprimer).
 */
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="relative">
                        <button
                            ...
                            className={`p-2 rounded-full transition-colors ${showSpeedMenu ? 'bg-olive/10 text-olive-dark' : 'text-gray-500 hover:text-charcoal hover:bg-gray-100'}`}
                        >
                            <Gauge size={18} />
                        </button>
                        {showSpeedMenu && (
